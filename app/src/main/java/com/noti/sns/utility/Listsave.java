...
public class Listsave {
    ...
    public static class HomeCardList {
        ...
        public static void add(String p0,String p1,String p2,String p3){
            ...
            edit.putString("Home_List_bythis" + add_num,p3);
        ...
        public static void remove(int p0){
            ...
            edit.remove("Home_List_bythis"+p0);
            edit.commit();
        }
        ...
        public static ArrayList<HomeCardListItem> get_Home_List(){
            ...
            int add_num = pref.getInt("Home_List_num",0);
            for(int i = 0;i<add_num;i++) {
                retun.add(new HomeCardListItem(pref.getString("Home_List_title" + i, ""), pref.getString("Home_List_subtitle" + i, ""), pref.getString("Home_List_inside" + i, ""),pref.getString("Home_List_bythis" + i, "")));
            }
            return retun;
        }
        ...
        public static void put_Home_List(ArrayList<HomeCardListItem> p0){
            ...
            for(int i = 0;i<p0.size();i++) {
                ...
                edit.putString("Home_List_bythis" + i, p0.get(i).bythis);
            }
            edit.commit();
        }
    }
